...
public class GaugeVertical extends UiComponent {
  ...
  public GaugeVertical(int x, int y, int w, int h, IntSupplier partial, IntSupplier full) {
    super(x, y, w, h);
    this.partial = partial;
    this.full = full;
  }

  public GaugeVertical withTexture(@Nullable TextureRegion emptyTex, @Nullable TextureRegion fullTex) {
