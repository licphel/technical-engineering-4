...
public abstract class TenScreen<T extends AbstractContainerMenu> extends AbstractContainerScreen<T> {
  protected final List<UiComponent> components = new ArrayList<>();
  protected EnhancedGuiGraphics graphics;

  public TenScreen(T menu, Inventory inv, Component title) {
