...
import com.hypothetic.ten4.lib.block.EnergyCableBlock;
import com.hypothetic.ten4.lib.block.DeviceBlock;
...
public final class ModBlocks {
  ...
  public static final DeferredHolder<Block, EnergyCableBlock> GLASS_ENERGY_CABLE =
      BLOCKS.register("glass_energy_cable", () -> new EnergyCableBlock(
          Block.Properties.of().mapColor(MapColor.NONE).strength(1.5F)
              .sound(SoundType.GLASS).noOcclusion(),
          ModBlockEntities.GLASS_ENERGY_CABLE::get));

  static {
    BLOCK_ITEMS.register("glass_energy_cable", () -> new BlockItem(GLASS_ENERGY_CABLE.get(), new Item.Properties()));
    ModCreativeTabs.deviceTab.add(() -> GLASS_ENERGY_CABLE.get().asItem());
  }
