...
public class RedstoneModeButton extends Button {
  ...
  public RedstoneModeButton(int x, int y, int w, int h, SyncedFieldReader reader, BlockPos pos) {
    super(x, y, w, h);
    this.reader = reader;
    setAction(() -> {
  ...
  public void onCollectingTooltips(List<Component> tooltips) {
    ...
    MutableComponent mc = Component.translatable(Ten4.lang("misc.sigmode"));
