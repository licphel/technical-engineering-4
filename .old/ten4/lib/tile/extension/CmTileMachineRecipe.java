package ten4.lib.tile.extension;
...
import ten4.lib.recipe.IBaseRecipeCm;
...
public abstract class CmTileMachineRecipe<T extends Recipe<? extends RecipeInput>> extends CmTileMachineProcess
{
    ...
    @Nullable
    public <E extends Recipe<? extends RecipeInput>> E getRecipe(RecipeType<E> type, ItemStack... stacks)
    {
        /*                                       @see FormsCombinedRecipe#matches*/
        return (E) ((Optional) RecipeHelper.safeGetRecipe(level, (RecipeType) type, new AdvancedInventory(stacks, slots, this))).orElse(null);
    }

    @SuppressWarnings({"unchecked", "rawtypes"})
    @Nullable
    public <E extends Recipe<? extends RecipeInput>> E getRecipe(RecipeType<E> type, AdvancedInventory inv)
    {
        return (E) ((Optional) RecipeHelper.safeGetRecipe(level, (RecipeType) type, inv)).orElse(null);
    }

    @SuppressWarnings({"unchecked", "rawtypes"})
    @Nullable
    public <E extends Recipe<? extends RecipeInput>> E getRecipe(RecipeType<E> type, RecipeInput inv)
    {
        return (E) ((Optional) RecipeHelper.safeGetRecipe(level, (RecipeType) type, inv)).orElse(null);
    }
