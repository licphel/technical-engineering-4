...
public class TransferManager
{
    ...
    public static final int CAP_ENERGY = 0;
    public static final int CAP_ITEM = 1;
    public static final int CAP_FLUID = 2;
    ...
    {
        if(!tile.hasFaceCapability(CAP_FLUID, d)) {
    ...
    {
        if(!tile.hasFaceCapability(CAP_ITEM, d)) {
            return FaceOption.NONE;
        }
        if(d == null) {
            return FaceOption.BOTH;
    ...
    {
        if(!tile.hasFaceCapability(CAP_ENERGY, d)) {
            return FaceOption.NONE;
        }
        if(d == null) {
            return FaceOption.BOTH;
