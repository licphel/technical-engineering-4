...
import ten4.core.item.energy.BlockItemFEStorage;
import ten4.core.item.upgrades.*;
import ten4.core.machine.useenergy.compressor.Mould;
import ten4.init.template.Bucket;
...
public class ItemInit
{
    ...
    static Map<String, DeferredHolder<Item, Item>> regs = new HashMap<>();
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(BuiltInRegistries.ITEM, TConst.modid);
    ...
    public static void regItem(String id, Supplier<Item> im)
    {
      ...
      DeferredHolder<Item, Item> reg = ITEMS.register(id, im);
        regs.put(id, reg);
