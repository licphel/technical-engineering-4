...
import ten4.TConst;
import ten4.core.block.*;
import ten4.core.block.mac.Machine4;
import ten4.core.block.mac.WateredMachine4;
import ten4.init.template.FluidBlock;
...
public class BlockInit
{
    ...
    static Map<String, DeferredHolder<Block, Block>> regs = new HashMap<>();
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(BuiltInRegistries.BLOCK, TConst.modid);
    ...
    public static void regBlock(String id, Supplier<Block> im)
    {
      ...
      DeferredHolder<Block, Block> reg = BLOCKS.register(id, im);
        regs.put(id, reg);
