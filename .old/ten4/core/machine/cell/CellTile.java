...
public class CellTile extends CmTileMachine
{
    ...
    {
        IEnergyStorage e = s.getCapability(Capabilities.EnergyStorage.ITEM);
        if(e != null) {
    ...
    public void update()
    {
        ...
        if(stack0.getCount() == 1) {
            IEnergyStorage e = stack0.getCapability(Capabilities.EnergyStorage.ITEM);
        ...
        if(stack1.getCount() == 1) {
            IEnergyStorage e = stack1.getCapability(Capabilities.EnergyStorage.ITEM);
