package ten4.core.machine.useenergy.quarry;
...
import ten4.TConst;
import ten4.core.item.upgrades.LevelupIce;
import ten4.core.item.upgrades.LevelupMagma;
import ten4.core.item.upgrades.LevelupMineral;
...
import ten4.util.WorkingHelper;
...
public class QuarryTile extends CmTileMachineRadiused
{
    ...
    {
        if(mode == 0) {
            return TagHelper.containsBlock(s.getBlock(), TagHelper.keyBlock("ten4:quarry_valids"))
