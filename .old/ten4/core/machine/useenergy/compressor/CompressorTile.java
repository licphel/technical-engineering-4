...
public class CompressorTile extends CmTileMachineRecipe<FormsCombinedRecipe>
{
    ...
    {
        if(TagHelper.containsItem(s.getItem(), TagHelper.keyItem("ten4:moulds"))) {
            return slot == 1;
        }
      List<FormsCombinedRecipe> o1 = RecipeHelper.getRecipeUsing(level, recipeType, inventory.getItem(1));
    ...
    {
        if(slot == 1) {
            return TagHelper.containsItem(stack.getItem(), TagHelper.keyItem("ten4:moulds"));
        }
        return true;
    }
